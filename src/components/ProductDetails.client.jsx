...
function NotifyWhenInStockMarkup() {
  return (
    <>
      <p className="text-lg">
      ...
      <form className="mb-2">
        <div className="mb-3">
          <label
            htmlFor="email"
            className="block mb-3 text-black text-sm font-bold"
          >
            Email Address
          </label>
          <input
        ...
        <button
          type="submit"
          className="bg-black text-white text-center font-mono font-semibold p-4 w-full border-4 border-white shadow-md"
        >
  ...
  return (
    <div className="space-y-4 mb-8">
      <Product.SelectedVariant.AddToCartButton
        className="text-center font-mono font-semibold p-4 w-full border-4 border-white shadow-md bg-primary text-white disabled:border-gray-300 disabled:bg-gray-300 disabled:shadow-none disabled:cursor-not-allowed"
        disabled={isOutOfStock}
      >
        {isOutOfStock ? 'Out of stock' : 'Add to bag'}
      </Product.SelectedVariant.AddToCartButton>
      {isOutOfStock ? (
        <NotifyWhenInStockMarkup />
      ) : (
                    ...
                    return value ? (
                      <span className="flex items-center">
                        <svg
                          ...
                          className="stroke-current text-primary mr-3"
                        >
                          <path
